    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 gap-4 justify-center pb-10">
                <div>
                    <button onclick=redirect("{{route('produtos.index',['loja' => $loja->id])}}") class="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                ...
                <!-- ... -->
                <div>
                    <button onclick=redirect("{{route('funcionarios.index',['loja' => $loja->id])}}") class="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
