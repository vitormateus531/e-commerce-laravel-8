            ...
            <div class="bg-white overflow-hidden pt-4 pb-10 shadow-xl sm:rounded-lg">
                <div class="flex justify-center space-x-10">
                    <div class="justify-center">
                        ...
                        <label class="mt-14 absolute -ml-8 font-bold">{{$funcionarios}}</label>
                    </div>
                    <div class="justify-center">
                        <i class="fas fa-dumpster text-5xl text-green-600"></i>
                        <label class="mt-14 absolute -ml-8 font-bold">{{$lojas}}</label>
                    </div>
                    <div class="justify-center">
                        <i class="fas fa-shopping-basket text-5xl text-gray-600"></i>
                        <label class="mt-14 absolute -ml-8 font-bold">{{$produtos}}</label>
                    </div>
                </div>
            </div>
        </div>
